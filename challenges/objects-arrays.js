...
const contactInfo = [];
for (let i = 0; i < graduates.length; i++) {
  if (graduates[i].first_name !== undefined && graduates[i].email !== undefined){
...
for (let i = 0; i < graduates.length; i++) {
 let sortUni = 'Uni';
 if (graduates[i].university.includes(sortUni)) {
...
populationTotal = zooAnimals.reduce(function(totalPop, currentPop) {
